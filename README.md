...
Setpiece is a Windows workspace manager built with Angular Material, a .NET Windows host, native window placement, widgets, and persistent WebView2 browsers.
...
Original wallpaper artwork and looping videos are under `Setpiece/Assets/Wallpapers`; their independent generator is `tools/create-wallpapers.py`. Some UI imagery and bundled software have separate upstream terms; see [third-party notices](THIRD-PARTY-NOTICES.md).

## Contributing

Issues and pull requests are welcome. See [CONTRIBUTING.md](CONTRIBUTING.md) for the project's contribution and license terms.
