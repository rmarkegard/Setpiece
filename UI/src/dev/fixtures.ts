...
export const services:Record<string,ServiceState>={
  ...
  discord:{status:'ready',title:'Setpiece Makers',detail:'4 members online',items:[{title:'Ruben',detail:'online'},{title:'Mira',detail:'online'},{title:'Tess',detail:'idle'},{title:'Jon',detail:'online'},{title:'Ada',detail:'dnd'}]},
